...
public class MorparaPaymentService : IMorparaPaymentService
{
    ...
    {
        new() { ProductCode="1274715", Alias="starter_monthly",  Name="Starter",         NameTr="Başlangıç",         PriceUsd=7.50m,  PriceTry=337m,   Credits=10,  DurationDays=30,  MaxInstallment=1,  IsYearly=false, IsCredit=false },
        new() { ProductCode="1274739", Alias="pro_monthly",      Name="Pro",              NameTr="Profesyonel",       PriceUsd=19.50m, PriceTry=877m,   Credits=40,  DurationDays=30,  MaxInstallment=1,  IsYearly=false, IsCredit=false },
        new() { ProductCode="1274779", Alias="business_monthly", Name="Business",         NameTr="İş",                PriceUsd=39.50m, PriceTry=1777m,  Credits=100, DurationDays=30,  MaxInstallment=1,  IsYearly=false, IsCredit=false },
        new() { ProductCode="1274716", Alias="starter_yearly",   Name="Starter Yıllık",  NameTr="Başlangıç Yıllık",  PriceUsd=49.50m, PriceTry=2227m,  Credits=120,  DurationDays=365, MaxInstallment=12, IsYearly=true,  IsCredit=false },
        new() { ProductCode="1274740", Alias="pro_yearly",       Name="Pro Yıllık",       NameTr="Profesyonel Yıllık",PriceUsd=149.50m,PriceTry=6727m,  Credits=480,  DurationDays=365, MaxInstallment=12, IsYearly=true,  IsCredit=false },
        new() { ProductCode="1274780", Alias="business_yearly",  Name="Business Yıllık",  NameTr="İş Yıllık",         PriceUsd=299.50m,PriceTry=13477m, Credits=1200, DurationDays=365, MaxInstallment=12, IsYearly=true,  IsCredit=false },
        new() { ProductCode="1274710", Alias="credit_10",        Name="10 Kredi",         NameTr="10 Ekstra Kredi",   PriceUsd=10m,    PriceTry=450m,   Credits=10,  DurationDays=0,   MaxInstallment=1,  IsYearly=false, IsCredit=true  },
        new() { ProductCode="1274725", Alias="credit_25",        Name="25 Kredi",         NameTr="25 Ekstra Kredi",   PriceUsd=20m,    PriceTry=1125m,   Credits=25,  DurationDays=0,   MaxInstallment=1,  IsYearly=false, IsCredit=true  },
        new() { ProductCode="1274750", Alias="credit_50",        Name="50 Kredi",         NameTr="50 Ekstra Kredi",   PriceUsd=35m,    PriceTry=1575m,  Credits=50,  DurationDays=0,   MaxInstallment=1,  IsYearly=false, IsCredit=true  },
    ...
    public async Task<MorparaPaymentResponseDto> InitializePaymentAsync(MorparaPaymentRequestDto request)
    {
        try
        {
            ...
            // Sadece TL ile ödeme alınacak
            decimal finalPrice = package.PriceTry;
            string currencyCode = "949"; // Sadece TRY
            string language = "tr";
            string pfSubMerchantId = _merchantId;
            ...
            await SavePendingPaymentAsync(conversationId, request.UserId, package,
                finalPrice, request.DiscountCode, discountPercent, "TRY");
