...
public class ToslaPaymentService : IToslaPaymentService
{
    ...
    {
        // ── Aylık paketler ────────────────────
        new() { ProductCode="1274715", Alias="starter_monthly",  Name="Starter",         NameTr="Başlangıç",         PriceUsd=10m,   PriceTry=1m,   Credits=10,   DurationDays=30,  MaxInstallment=1,  IsYearly=false, IsCredit=false, Description="Starter Aylık Üyelik" },
